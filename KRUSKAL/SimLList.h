...
*/ 
struct SimpleLinkedListInt * insertAtEndSimpleLinkedListInt(struct SimpleLinkedListInt **proot,int data,int weight){
...
struct SimpleLinkedListInt * insertAtBeginningSimpleLinkedListInt(struct SimpleLinkedListInt **proot,int data,int weight){
	struct SimpleLinkedListInt *newNode=(struct SimpleLinkedListInt *)malloc(sizeof(struct SimpleLinkedListInt));
	if(newNode==NULL){
...
struct SimpleLinkedListInt* insertAfterPosSimpleLinkdListInt(struct SimpleLinkedListInt **proot,int data,int pos,int weight){
	struct SimpleLinkedListInt *newNode=(struct SimpleLinkedListInt *)malloc(sizeof(struct SimpleLinkedListInt));
	if(newNode==NULL){
