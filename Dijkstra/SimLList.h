#include<stdio.h>
#include<malloc.h>
struct SimpleLinkedListInt* insertAtEndSimpleLinkedListInt(struct SimpleLinkedListInt **, int);
struct SimpleLinkedListInt* insertAtBeginningSimpleLinkedListInt(struct SimpleLinkedListInt **, int);
struct SimpleLinkedListInt* insertAfterPosSimpleLinkdListInt(struct SimpleLinkedListInt **,int,int);
...
*/ 
struct SimpleLinkedListInt * insertAtEndSimpleLinkedListInt(struct SimpleLinkedListInt **proot,int data){
...
struct SimpleLinkedListInt * insertAtBeginningSimpleLinkedListInt(struct SimpleLinkedListInt **proot,int data){
	struct SimpleLinkedListInt *newNode=(struct SimpleLinkedListInt *)malloc(sizeof(struct SimpleLinkedListInt));
	if(newNode==NULL){
...
struct SimpleLinkedListInt* insertAfterPosSimpleLinkdListInt(struct SimpleLinkedListInt **proot,int data,int pos){
	struct SimpleLinkedListInt *newNode=(struct SimpleLinkedListInt *)malloc(sizeof(struct SimpleLinkedListInt));
	if(newNode==NULL){
